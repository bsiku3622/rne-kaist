...
Not a training run -- a dataset analysis. Reproduce with:
    ...
    python models/spectral/dataset.py --run torch_20260710-132221_100_700_0.125 --detrend

Dataset: `data/torch_20260710-132221_100_700_0.125`  (100-700 W, 0.125 mm), with the x-wrap ramp taken out first
