...
Not a training run -- a dataset analysis. Reproduce with:
    ...
    python models/spectral/dataset.py --run torch_20260710-122446_100_250_0.25 --detrend

Dataset: `data/torch_20260710-122446_100_250_0.25`  (100-250 W, 0.25 mm), with the x-wrap ramp taken out first
